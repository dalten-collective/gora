            ...
            ;div(class "menu-buttons")
              ;div(class "button-layout")
                ;div(class "button-wrapper")
                  ;a(id "give", class "button", href "localhost")
              ...
              ::
                ;div(class "button-wrapper")
                  ;a(id "take", class "button", href "localhost")
                    ;svg(xmlns "http://www.w3.org/2000/svg", height "48", width "48")
              ...
              ::
                ;div(class "button-wrapper")
                  ;a(id "make", class "button", href "localhost")
                    ;svg(xmlns "http://www.w3.org/2000/svg", height "48", width "48")
  ...
  * {
  ...
  @media (max-aspect-ratio: 9/16) {
    ...
    .title-glass {
      ...
      backdrop-filter: brightness(0.6) grayscale() blur(1.5px);
    }
